...
class PdfManage
{
    ...
    public function addPDFURL($url)
    {
        $pdfData = file_get_contents($url);
        $this->_urlDataArray[] = $pdfData;
    }

    public function mergePDFURL($outputmode = 'browser', $outputpath = 'newfile.pdf', $orientation = 'P')
    {
        ...
        // merger operations
        foreach ($this->_urlDataArray as $urlData) {
            $fileorientation = $orientation;

            $count = $fpdi->setSourceData($urlData);
            //add the pages
